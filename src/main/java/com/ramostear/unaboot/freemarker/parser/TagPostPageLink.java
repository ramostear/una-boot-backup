 ...
 * @Description ${una_categoryPostPage("${una}/${tag.slug}?offset=1",${category.id},offset,15,15)}
 * @Author ramostear
 * @Date 2019/11/22 0022 23:40
 * @Version 1.0
 **/
@Service
public class TagPostPageLink extends BaseMethod {
    @Autowired
    ...
    public Object exec(List arguments) throws TemplateModelException {
        ...
        Integer tagId = getInteger(arguments,1);
        ...
        Page<Post> data = postTagService.pageAllPostByTagIdAndPostStatus(tagId,1,
                PageRequest.of(offset-1,size));
