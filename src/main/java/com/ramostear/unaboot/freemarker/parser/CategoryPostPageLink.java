 ...
 **/
@Service
public class CategoryPostPageLink extends BaseMethod {
    @Autowired
    ...
    public Object exec(List arguments) throws TemplateModelException {
        ...
        Integer categoryId = getInteger(arguments,1);
        ...
        Page<Post> data = postCategoryService.pagePostByCategoryId(categoryId,
